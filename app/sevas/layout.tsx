...
export const metadata: Metadata = {
  ...
  description:
    "Book sacred rituals and offerings at Sri Kanukondaraya Swamy Devasthanam. Browse Archana, Abhishekam, Homam, Kalyanam, Annadanam and more. Book via WhatsApp.",
  keywords: [
    "temple sevas",
    "Archana booking",
    "Abhishekam",
    ...
    "Kanukondaraya Swamy puja",
    "seva booking WhatsApp",
  ],
  openGraph: {
    title: "Temple Sevas – Sri Kanukondaraya Swamy Devasthanam",
    description:
